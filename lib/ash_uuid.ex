defmodule AshUUID do
  ...
  def uuid_type(%AshUUID.Config{version: 4, encoded?: true, prefixed?: false}),
    do: AshUUID.EncodedV4

  def uuid_type(%AshUUID.Config{version: 7, encoded?: true, prefixed?: false}),
    do: AshUUID.EncodedV7

  def uuid_type(%AshUUID.Config{version: 4, encoded?: true, prefixed?: true}),
    do: AshUUID.PrefixedV4

  def uuid_type(%AshUUID.Config{version: 7, encoded?: true, prefixed?: true}),
    do: AshUUID.PrefixedV7
  ...
  def format?(
        <<_g1::binary-size(8), ?-, _g2::binary-size(4), ?-, _g3::binary-size(4), ?-,
          _g4::binary-size(4), ?-, _g5::binary-size(12)>> = _string_uuid
      ),
      do: :string_uuid
  ...
  def format?(string) when is_binary(string) do
    case String.split(string, "_") do
      ...
      [<<_string_uuid::binary-size(32)>>] -> :hex_string_uuid
      _ -> :unknown
    end
  end
